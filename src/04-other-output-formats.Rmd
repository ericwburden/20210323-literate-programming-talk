...
In fact, this website/presentation was written entirely in R Markdown (with a smidge of YAML and CSS). YOu can view this presentation anytime online^[https://literate-programming.ericburden.page] and the source code is publicly available on GitHub.^[https://github.com/ericwburden/20210323-literate-programming-talk]
